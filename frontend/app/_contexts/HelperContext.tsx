...
type HelperContextType = {
  ...
  setBeforeUserDecision: React.Dispatch<React.SetStateAction<CharacterResponse | undefined>>;
  ...
  return (
    <HelperContext.Provider 
      value={{ currentUser, setCurrentUser,
               ...
               beforeQueryText, setBeforeQueryText,
               userDecision, setUserDecision,
               beforeUserDecision, setBeforeUserDecision,
               remainingTokens, setRemainingTokens,
               conversationCount, setConversationCount,
               inputTags, setInputTags,
               displayTags, setDisplayTags,
               labelBgColor, setLabelBgColor,
               labelTextColor, setLabelTextColor,
               tagAlert, setTagAlert,
               isClickInformation, setIsClickInformation,
               isSaveDecision, setIsSaveDecision,
               fetchHelperInitData}}>
      {children}
    </HelperContext.Provider>
  );
